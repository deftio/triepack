...
library. Both the JavaScript and Python bindings validate against these
fixtures to ensure binary-level compatibility across all three implementations:
...
- **Encode**: Encode the same data in Python/JavaScript and verify the output is byte-identical to the C fixture
